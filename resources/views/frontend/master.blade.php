...
<head>
	...
	<!-- Favicon-->
	<link rel="icon" sizes="57x57" href="{{ asset('front/favicon/apple-icon-57x57.png')}}">
...
<body>
	...
	<div class="container-fluid">
			...
			<div class="col-xl-6 col-lg-6 col-md-4 col-sm-2 col-2 order-xl-2 order-lg-2 order-md-3 order-sm-3 order-3">
				<div class="row">
					...
					<div class="col-lg-4 col-10">
						...
						<a class="d-xl-block d-lg-block d-md-block d-none text-decoration-none loginLink float-left" href="{{ route('loginpage') }}">
						{{ __('Login|') }}</a>

						@if (Route::has('register'))
						<a class="d-xl-block d-lg-block d-md-block d-none text-decoration-none loginLink float-left" href="{{ route('register') }}">
						{{ __('Register') }}</a>
						@endif
						@else
		...
		<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 order-xl-3 order-lg-3 order-md-4 order-sm-4 order-4 text-right">
			...
			<a href=""><img src="{{ asset('front/image/download.png')}}" class="img-fluid d-xl-inline d-lg-inline d-md-none d-sm-none d-none" style="width: 150px"></a>
		</div>
	</div>
</div>
<div id="myPage"></div>
